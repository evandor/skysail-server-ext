...
/**
 * This is the item provider adapter for a {@link de.twenty11.skysail.server.ext.notes.Folder} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FolderItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 NotesPackage.Literals.FOLDER__NAME,
                 true,
                 false,
                 false,
    ...
    protected void addPathPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Folder_path_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Folder_path_feature", "_UI_Folder_type"),
                 NotesPackage.Literals.FOLDER__PATH,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(NotesPackage.Literals.FOLDER__NOTES);
            childrenFeatures.add(NotesPackage.Literals.FOLDER__SUBFOLDERS);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (NotesPackage.Literals.FOLDER__NOTES,
                 NotesFactory.eINSTANCE.createNote()));

        newChildDescriptors.add
            (createChildParameter
                (NotesPackage.Literals.FOLDER__SUBFOLDERS,
                 NotesFactory.eINSTANCE.createFolder()));
    }
