<#include "skysail.server.ext.dbviewer:head.ftl">
...
<body>
  ...
  <div id="container">
    ...
    <#include "skysail.server.ext.dbviewer:title.ftl">
        ...
        <#list component.gridData as row>
          ...
          <#list columns as columnData>
            <#if columnData_index == 0>
                <td><img src="${contextPath}static/img/bundle.gif" align="top">&nbsp;<a href="${columns[0]}/data/">${columnData}</a></td>
            ...
            <td><img src="${contextPath}static/img/bundle.gif" align="top">&nbsp;<a href="${columns[0]}/columns/">Columns</a></td>
          </tr>  
        </#list>
        </tbody> 
        </table>  
