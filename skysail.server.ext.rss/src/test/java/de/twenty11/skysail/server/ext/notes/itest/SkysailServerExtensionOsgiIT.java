...
public class SkysailServerExtensionOsgiIT {
    ...
    public Option[] config() {
        ...
        String currentBundleSource = "file:target/skysail.server.ext.rss-" + setup.getProjectVersion() + ".jar";
    ...
    public void should_find_Bundle_in_active_State() {
        Bundle bundle = OsgiTestingUtils.getBundleForSymbolicName(context, "skysail.server.ext.rss");
        assertTrue(bundle != null);
        assertTrue(bundle.getState() == 32);
    }
