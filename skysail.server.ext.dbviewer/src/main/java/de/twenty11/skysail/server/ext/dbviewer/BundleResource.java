...
//import de.twenty11.skysail.server.ext.dbviewer.internal.DbViewer;
...
//        String bundleName = (String) getRequest().getAttributes().get(DbViewerUrlMapper.RESTLET_BUNDLE_NAME_ID);
//        Bundle bundle = DbViewer.getInstance().getBundle(bundleName);
