...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>notes</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class NotesExample {
    ...
    public static void main(String[] args) {
        ...
        resourceSet.getPackageRegistry().put
            (NotesPackage.eNS_URI, 
             NotesPackage.eINSTANCE);
        ...
        if (args.length == 0) {
            ...
            try {
                Resource resource = resourceSet.createResource(URI.createURI("http:///My.notes"));
                Note root = NotesFactory.eINSTANCE.createNote();
